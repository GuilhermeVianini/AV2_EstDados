...
public class ArvoreAVL {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    // Inserir dados do arquivo dados.txt
                    try {
                        Scanner fileScanner = new Scanner(new File("dados.txt"));
                        while (fileScanner.hasNextInt()) {
                            int value = fileScanner.nextInt();
                            avlTree.root = avlTree.insert(avlTree.root, value);
                        }
                        System.out.println("Dados inseridos do arquivo dados.txt.");
                ...
                case 2:
                    ...
                    avlTree.root = avlTree.deleteNode(avlTree.root, deleteValue);
                    System.out.println("Valor excluído com sucesso!");
                    avlTree.print(avlTree.root); // Mostrar a nova árvore
                    break;
                case 3:
                    // Pesquisar valor
                    System.out.println("Digite o valor a ser pesquisado:");
                    int searchValue = scanner.nextInt();
                    boolean found = avlTree.search(avlTree.root, searchValue);
                    if (found) {
